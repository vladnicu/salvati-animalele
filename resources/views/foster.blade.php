...
@section('content')
    ...
    @include('partials.featurette-list', [
        'titleprimary' => 'Nu ești singur. Noi suntem alături de ',
        'titlesecondary' => 'tine.',
        'text' =>
            'Mulți oameni își doresc să ajute, dar se tem că nu vor face față costurilor sau responsabilității. Tu oferi spațiul și grija, Noi ne ocupăm de restul și suntem alături de tine pe tot parcursul fosterului. De aceea, vrem să fie foarte clar:',
        'listText' => 'Asociația Salvați Animalele asigură TOT ce este necesar:',
        'listItems' => ['Vaccinuri', 'Deparazitări', 'Mâncare', 'Jucării', 'Pături', 'Tarcuri și alte materiale'],
    ])

    <hr class="featurette-divider" />

    @include('partials.featurette-list', [
        'titleprimary' => 'De ce să devii ',
        'titlesecondary' => 'foster?',
        'text' => 'Poate părea un gest mic. Pentru un pui, înseamnă totul.',
        'listText' => 'Pentru că: ',
        'listItems' => [
            'Reduci semnificativ riscul de îmbolnăvire',
            'Ajuți direct un pui extrem de vulnerabil',
            'Faci parte dintr-un lanț real de salvare',
            'Oferi o șansă la viață acolo unde altfel nu ar exista',
        ],
    ])
