...
@section('content')
    ...
    <div class="row">
        <div class="col">
            ...
            <p>În fiecare zi, în adăpost ajung pui foarte mici și fragili — pui care nu ar trebui să lupte deja pentru
                supraviețuire.</p>
            <p>Pentru ei, mediul unui adăpost, oricât de bine organizat ar fi, vine cu un risc major: parvoviroza.</p>
            <p>Parvoviroza este o boală extrem de gravă și foarte contagioasă, care se răspândește ușor acolo unde sunt
                mulți câini. Pentru un pui, mai ales unul care nu a finalizat schema de vaccinare, șansele de
                supraviețuire scad dramatic dacă rămâne în adăpost.</p>

            <h5></h5>
            <h5></h5>
            <div class="alert alert-primary" role="alert">
                <h4 class="alert-heading">Ce înseamnă să devii îngerul păzitor al unui câine?</h4>
                <p class="mb-0">De ce fosterul face diferența</p>
            </div>
