...
@section('content')
    <div class="homepage-image-1-row d-flex justify-content-center position-relative d-inline-block">
        <img src="{{ Vite::asset('resources/images/Poza homepage 1.png') }}" class="img-fluid" alt="...">
    ...
    <div class="row mt-4">
        <div class="col d-flex justify-content-center"><button type="button" class="btn btn-danger">Foster – găzduire
                temporară pentru câini</button></div>
        <div class="col d-flex justify-content-center"><button type="button" class="btn btn-danger">Sponsorizează un
                câine</button></div>
        <div class="col d-flex justify-content-center"><button type="button" class="btn btn-danger">Fă o donație</button>
        </div>
    </div>

    <div class="row mt-4">
        <div class="col d-flex justify-content-center"><img src="{{ Vite::asset('resources/images/Poza homepage 2.jpg') }}" class="img-thumbnail" width="408" height="283"
                alt="..."></div>
        <div class="col-8">
    ...
    <div class="row py-5 px-2 difference-row">
        <div class="col d-flex flex-column align-items-center justify-content-center">
            <h2>Donează și schimbă o viață</h2>
            <button type="button" class="btn btn-light">Donează acum</button>
        </div>

        <div class="col d-flex flex-column align-items-center justify-content-center">
            <h2>Implică-te ca voluntar</h2>
            <button type="button" class="btn btn-light">Informații voluntariat</button>
        </div>
        <div class="col d-flex flex-column align-items-center justify-content-center">
            <h2>Sponsorizează un câine</h2>
            <button type="button" class="btn btn-light">Devino sponsor</button>
        </div>
    </div>
@endsection
