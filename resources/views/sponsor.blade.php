...
@section('content')
    <div class="row">
        <div class="col">
            ...
            <ul>
                <li>investigații și tratamente medicale</li>
                <li>medicamente și intervenții necesare</li>
                <li>îngrijire zilnică și monitorizare</li>
                <li>hrană specială și condiții de confort pentru câinii bătrâni</li>
            </ul>
